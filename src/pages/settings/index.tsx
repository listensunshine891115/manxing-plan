  ...
  return (
    <View className="min-h-screen bg-gray-50 pb-safe">
      ...
      <View className="px-4 mb-4">
        <Text className="block text-xs text-gray-500 uppercase mb-2 px-1">公众号绑定</Text>
        <Card>
          <View 
          ...
          >
            <View className="flex items-center gap-3">
              ...
              <View>
                <Text className="block text-sm font-medium text-gray-900">绑定公众号</Text>
                <Text className="block text-xs text-gray-500 mt-1">
                  {userInfo.wx_openid ? '已绑定，可发送链接自动收录' : '未绑定，绑定后发送链接自动收录'}
                </Text>
              </View>
            </View>
